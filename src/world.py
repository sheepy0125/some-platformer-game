...
class Tile:
    ...
    def draw(self):
        if self.x - Scrolling.scroll_x < SCREEN_SIZE[0] and self.x + TILE_SIZE - Scrolling.scroll_x > 0:
            if self.y - Scrolling.scroll_y < SCREEN_SIZE[1] and self.y + TILE_SIZE - Scrolling.scroll_y > 0:
                screen.blit(
